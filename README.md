...
|---|---|---|
| `uname -s` = `Linux`, `uname -m` = `x86_64` | `x86_64-unknown-linux-gnu` | [`sqlite-mcp-x86_64-unknown-linux-gnu.tar.gz`](https://github.com/tilmon-engineering/sqlite-mcp/releases/download/v0.3.0/sqlite-mcp-x86_64-unknown-linux-gnu.tar.gz) |
| `uname -s` = `Linux`, `uname -m` = `aarch64` | `aarch64-unknown-linux-gnu` | [`sqlite-mcp-aarch64-unknown-linux-gnu.tar.gz`](https://github.com/tilmon-engineering/sqlite-mcp/releases/download/v0.3.0/sqlite-mcp-aarch64-unknown-linux-gnu.tar.gz) |
| `uname -s` = `Darwin`, `uname -m` = `arm64` | `aarch64-apple-darwin` | [`sqlite-mcp-aarch64-apple-darwin.tar.gz`](https://github.com/tilmon-engineering/sqlite-mcp/releases/download/v0.3.0/sqlite-mcp-aarch64-apple-darwin.tar.gz) |
| `uname -s` = `Darwin`, `uname -m` = `x86_64` | `x86_64-apple-darwin` | [`sqlite-mcp-x86_64-apple-darwin.tar.gz`](https://github.com/tilmon-engineering/sqlite-mcp/releases/download/v0.3.0/sqlite-mcp-x86_64-apple-darwin.tar.gz) |
